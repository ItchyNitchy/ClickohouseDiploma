...
create materialized view sanitation_of_settlements.sorting_and_recycling_detailed_per_region_mv to sanitation_of_settlements.collection_and_disposal_per_region
as select
    source.year as year,
    source.district_id as district_id,
    source.region_id as region_id,
